...
public class PessoaJuridicaFactoryTest {
	...
	public void test_quandoCriarEntityPeloVO_sohTransformaparaEntity() {
		...
		PessoaJuridicaEntity entityCriada = 
				new PessoaJuridicaFactory(pessoaVO).toEntity();
		...
		assertNotNull(entityCriada.getNrCnpj());
		assertEquals(pessoaVO.getNrCnpj(),entityCriada.getNrCnpj());
		...
		PessoaVO voCriado = 
				new PessoaJuridicaFactory(entityCriada).toVO();
		...
		assertNotNull(voCriado.getNrCnpj());
		assertEquals(pessoaVO.getNrCnpj(),voCriado.getNrCnpj());
